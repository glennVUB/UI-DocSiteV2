...
//:page-role: -toc
:page-pagination:
:page-last-updated: 9 juni 2026
:page-last-updated-iso: 2026-06-09
...
<div class="content">
<pre class="highlightjs highlight"><code class="language-yaml hljs" data-lang="yaml" data-highlight-lines="2..3">- hosts: switches
  tasks:
    - name: configure vlan
      ios_vlan:
        vlan_id: 10
